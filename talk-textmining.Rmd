...
rmarkdown::paged_table(head(data, 3))
```
...
data_af <- read.csv("https://github.com/guadag12/talk-textmining-uba/raw/gh-pages/data/data_af.csv")
rmarkdown::paged_table(head(data.frame(text =data_af[,"text"]), 3))
```
